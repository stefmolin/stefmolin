...
- [pyOpenSci/python-package-guide](https://github.com/pyOpenSci/python-package-guide) - Python packaging made simple. Recommendations &amp; guidance curated by the pyOpenSci community (5 days ago)

#### 🔭 Latest releases I've contributed to

- [stefmolin/docstringify](https://github.com/stefmolin/docstringify) ([1.0.0](https://github.com/stefmolin/docstringify/releases/tag/1.0.0), 5 days ago) - Flag missing docstrings and, optionally, generate them from signatures and type annotations.
