...
- [pola-rs/polars](https://github.com/pola-rs/polars) ([py-1.6.0](https://github.com/pola-rs/polars/releases/tag/py-1.6.0), 6 days ago) - Dataframes powered by a multithreaded, vectorized query engine, written in Rust
...
- [sqlalchemy/sqlalchemy](https://github.com/sqlalchemy/sqlalchemy) ([rel_2_0_32](https://github.com/sqlalchemy/sqlalchemy/releases/tag/rel_2_0_32), 4 weeks ago) - The Database Toolkit for Python
