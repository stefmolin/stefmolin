...
- [celery/celery](https://github.com/celery/celery) ([v5.5.0b2](https://github.com/celery/celery/releases/tag/v5.5.0b2), 1 day ago) - Distributed Task Queue (development branch)
- [sqlalchemy/sqlalchemy](https://github.com/sqlalchemy/sqlalchemy) ([rel_2_0_32](https://github.com/sqlalchemy/sqlalchemy/releases/tag/rel_2_0_32), 2 days ago) - The Database Toolkit for Python
- [pola-rs/polars](https://github.com/pola-rs/polars) ([py-1.4.1](https://github.com/pola-rs/polars/releases/tag/py-1.4.1), 3 days ago) - Dataframes powered by a multithreaded, vectorized query engine, written in Rust
- [pyOpenSci/python-package-guide](https://github.com/pyOpenSci/python-package-guide) ([v0.4](https://github.com/pyOpenSci/python-package-guide/releases/tag/v0.4), 6 days ago) - scientific Python package recommendations &amp; guidance curated by pyOpenSci
