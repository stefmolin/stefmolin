...
- [stefmolin/exif-stripper](https://github.com/stefmolin/exif-stripper) ([0.5.1](https://github.com/stefmolin/exif-stripper/releases/tag/0.5.1), today) - An easy-to-use tool to ensure image metadata (EXIF data and extended attributes) is removed.
