...
- [executablebooks/sphinx-design](https://github.com/executablebooks/sphinx-design) - A sphinx extension for designing beautiful, screen-size responsive web components. (6 days ago)
- [fastapi/sqlmodel](https://github.com/fastapi/sqlmodel) - SQL databases in Python, designed for simplicity, compatibility, and robustness. (3 weeks ago)
...
- [sqlalchemy/sqlalchemy](https://github.com/sqlalchemy/sqlalchemy) ([rel_2_1_0b1](https://github.com/sqlalchemy/sqlalchemy/releases/tag/rel_2_1_0b1), 4 days ago) - The Database Toolkit for Python
- [executablebooks/sphinx-design](https://github.com/executablebooks/sphinx-design) ([v0.7.0](https://github.com/executablebooks/sphinx-design/releases/tag/v0.7.0), 6 days ago) - A sphinx extension for designing beautiful, screen-size responsive web components.
- [fastapi/sqlmodel](https://github.com/fastapi/sqlmodel) ([0.0.31](https://github.com/fastapi/sqlmodel/releases/tag/0.0.31), 4 weeks ago) - SQL databases in Python, designed for simplicity, compatibility, and robustness.
