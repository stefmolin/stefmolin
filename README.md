...
- [pola-rs/polars](https://github.com/pola-rs/polars) ([rs-0.42.0](https://github.com/pola-rs/polars/releases/tag/rs-0.42.0), 4 days ago) - Dataframes powered by a multithreaded, vectorized query engine, written in Rust
