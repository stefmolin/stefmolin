...
- [python-spain/web-ng](https://github.com/python-spain/web-ng) - Web de la asociación Python España (realizada con GatsbyJS) (2 weeks ago)
...
- [sqlalchemy/sqlalchemy](https://github.com/sqlalchemy/sqlalchemy) ([rel_2_0_47](https://github.com/sqlalchemy/sqlalchemy/releases/tag/rel_2_0_47), 6 days ago) - The Database Toolkit for Python
- [fastapi/sqlmodel](https://github.com/fastapi/sqlmodel) ([0.0.37](https://github.com/fastapi/sqlmodel/releases/tag/0.0.37), 1 week ago) - SQL databases in Python, designed for simplicity, compatibility, and robustness.
