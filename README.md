...
- [fastapi/sqlmodel](https://github.com/fastapi/sqlmodel) ([0.0.34](https://github.com/fastapi/sqlmodel/releases/tag/0.0.34), 4 days ago) - SQL databases in Python, designed for simplicity, compatibility, and robustness.
- [sqlalchemy/sqlalchemy](https://github.com/sqlalchemy/sqlalchemy) ([rel_2_1_0b1](https://github.com/sqlalchemy/sqlalchemy/releases/tag/rel_2_1_0b1), 1 month ago) - The Database Toolkit for Python
