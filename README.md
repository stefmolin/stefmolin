...
- [stefmolin/pre-commit-workshop](https://github.com/stefmolin/pre-commit-workshop) - &#34;(Pre-)Commit to Better Code&#34; workshop (2 weeks ago)
...
- [numpy/numpydoc](https://github.com/numpy/numpydoc) - Numpy&#39;s Sphinx extensions (4 weeks ago)

#### 🔭 Latest releases I've contributed to

- [numpy/numpydoc](https://github.com/numpy/numpydoc) ([v1.9.0](https://github.com/numpy/numpydoc/releases/tag/v1.9.0), 6 days ago) - Numpy&#39;s Sphinx extensions
- [sigstore/gh-action-sigstore-python](https://github.com/sigstore/gh-action-sigstore-python) ([v3.0.1](https://github.com/sigstore/gh-action-sigstore-python/releases/tag/v3.0.1), 1 week ago) - A GitHub Action for sigstore-python
- [stefmolin/exif-stripper](https://github.com/stefmolin/exif-stripper) ([1.0.0](https://github.com/stefmolin/exif-stripper/releases/tag/1.0.0), 2 weeks ago) - An easy-to-use tool to ensure image metadata (EXIF) is removed.
