...
- [pola-rs/polars](https://github.com/pola-rs/polars) ([rs-0.44.1](https://github.com/pola-rs/polars/releases/tag/rs-0.44.1), 1 day ago) - Dataframes powered by a multithreaded, vectorized query engine, written in Rust
- [stefmolin/exif-stripper](https://github.com/stefmolin/exif-stripper) ([0.5.0](https://github.com/stefmolin/exif-stripper/releases/tag/0.5.0), 3 days ago) - An easy-to-use tool to ensure image metadata (EXIF data and extended attributes) is removed.
