...
- [fastapi/sqlmodel](https://github.com/fastapi/sqlmodel) ([0.0.32](https://github.com/fastapi/sqlmodel/releases/tag/0.0.32), today) - SQL databases in Python, designed for simplicity, compatibility, and robustness.
