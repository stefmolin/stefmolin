...
- [stefmolin/exif-stripper](https://github.com/stefmolin/exif-stripper) - An easy-to-use tool to ensure image metadata (EXIF data and extended attributes) is removed. (1 week ago)
...
- [pola-rs/polars](https://github.com/pola-rs/polars) ([py-1.11.0](https://github.com/pola-rs/polars/releases/tag/py-1.11.0), 4 days ago) - Dataframes powered by a multithreaded, vectorized query engine, written in Rust
