...
- [pola-rs/polars](https://github.com/pola-rs/polars) ([rs-0.44.1](https://github.com/pola-rs/polars/releases/tag/rs-0.44.1), today) - Dataframes powered by a multithreaded, vectorized query engine, written in Rust
