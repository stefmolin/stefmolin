...
- [python-spain/web-ng](https://github.com/python-spain/web-ng) - Web de la asociación Python España (realizada con GatsbyJS) (3 weeks ago)
...
- [stefmolin/data-morph-talk](https://github.com/stefmolin/data-morph-talk) - Slides for my talk &#34;Data Morph: A Cautionary Tale of Summary Statistics&#34; (3 months ago)

#### 🔭 Latest releases I've contributed to

- [sqlalchemy/sqlalchemy](https://github.com/sqlalchemy/sqlalchemy) ([rel_2_0_48](https://github.com/sqlalchemy/sqlalchemy/releases/tag/rel_2_0_48), 6 days ago) - The Database Toolkit for Python
- [fastapi/sqlmodel](https://github.com/fastapi/sqlmodel) ([0.0.37](https://github.com/fastapi/sqlmodel/releases/tag/0.0.37), 2 weeks ago) - SQL databases in Python, designed for simplicity, compatibility, and robustness.
...
- [numpy/numpydoc](https://github.com/numpy/numpydoc) ([v1.10.0](https://github.com/numpy/numpydoc/releases/tag/v1.10.0), 3 months ago) - Numpy&#39;s Sphinx extensions
