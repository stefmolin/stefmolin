...
- [commitizen-tools/commitizen](https://github.com/commitizen-tools/commitizen) ([v4.5.1](https://github.com/commitizen-tools/commitizen/releases/tag/v4.5.1), 3 days ago) - Create committing rules for projects :rocket: auto bump versions :arrow_up: and auto changelog generation :open_file_folder: 
