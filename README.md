...
- [cosimameyer/awesome-pyladies-creations](https://github.com/cosimameyer/awesome-pyladies-creations) - 👩‍💻 Repository with Awesome PyLadies&#39; content (2 days ago)
...
- [python/cpython](https://github.com/python/cpython) - The Python programming language (4 days ago)

## 🔭 Latest releases I've contributed to

- [stefmolin/docstringify](https://github.com/stefmolin/docstringify) ([2.0.0](https://github.com/stefmolin/docstringify/releases/tag/2.0.0), 3 weeks ago) - Flag missing docstrings and, optionally, generate them from signatures and type annotations.
- [hakimel/reveal.js](https://github.com/hakimel/reveal.js) ([6.0.1](https://github.com/hakimel/reveal.js/releases/tag/6.0.1), 1 month ago) - The HTML Presentation Framework
- [fastapi/sqlmodel](https://github.com/fastapi/sqlmodel) ([0.0.38](https://github.com/fastapi/sqlmodel/releases/tag/0.0.38), 1 month ago) - SQL databases in Python, designed for simplicity, compatibility, and robustness.
