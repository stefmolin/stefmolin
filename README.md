...
- [stefmolin/docstringify](https://github.com/stefmolin/docstringify) ([1.1.0](https://github.com/stefmolin/docstringify/releases/tag/1.1.0), 1 day ago) - Flag missing docstrings and, optionally, generate them from signatures and type annotations.
