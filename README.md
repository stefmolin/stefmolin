...
- [sqlalchemy/sqlalchemy](https://github.com/sqlalchemy/sqlalchemy) ([rel_2_0_48](https://github.com/sqlalchemy/sqlalchemy/releases/tag/rel_2_0_48), 2 weeks ago) - The Database Toolkit for Python
- [fastapi/sqlmodel](https://github.com/fastapi/sqlmodel) ([0.0.37](https://github.com/fastapi/sqlmodel/releases/tag/0.0.37), 4 weeks ago) - SQL databases in Python, designed for simplicity, compatibility, and robustness.
