...
- [pola-rs/polars](https://github.com/pola-rs/polars) ([py-1.7.0](https://github.com/pola-rs/polars/releases/tag/py-1.7.0), 1 day ago) - Dataframes powered by a multithreaded, vectorized query engine, written in Rust
- [celery/celery](https://github.com/celery/celery) ([v5.5.0b3](https://github.com/celery/celery/releases/tag/v5.5.0b3), 4 days ago) - Distributed Task Queue (development branch)
